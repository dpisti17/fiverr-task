...
import hu.zoom.image.views.originalimagecomponent.SampleView;
...
public class MainLayout extends AppLayout {
	...
	private List<Tab> createMenuItems() {
		MenuItemInfo[] menuItems = new MenuItemInfo[] { //
				new MenuItemInfo("Images", "la la-image", SampleView.class), //
	...
	private static Tab createTab(final MenuItemInfo menuItemInfo) {
		Tab tab = new Tab();
